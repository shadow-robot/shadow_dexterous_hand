...
RUN set +x && \
    ...
    gosu $MY_USERNAME /tmp/oneliner -w $PROJECTS_WS/base -r sr-build-tools -b $toolset_branch -i data/shadow_robot-kinetic.rosinstall -v "melodic" -t mongodb,pyassimp,pyqtgraph && \
    \
